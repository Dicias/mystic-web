    ...
    <div className="flex min-h-[200px] items-center justify-center overflow-hidden">
      <div className="relative isolate flex h-24 w-44 items-center justify-center">
        ...
        <div className="absolute z-30 h-4 w-4 animate-quantum-red">
          <div className="h-full w-full rounded-full bg-brand-red shadow-[0_0_12px_rgba(224,35,28,0.75),0_0_24px_rgba(224,35,28,0.3)]" />
        </div>

        {/* BLACK — Large outer particle */}
        <div className="absolute z-10 h-6 w-6 animate-quantum-blue">
          <div className="h-full w-full rounded-full bg-brand-black shadow-[0_0_16px_rgba(13,13,13,0.55),0_0_30px_rgba(13,13,13,0.2)]" />
        </div>

        {/* YELLOW — Center particle */}
        <div className="absolute z-40 h-5 w-5 animate-quantum-yellow">
          <div className="h-full w-full rounded-full bg-brand-yellow shadow-[0_0_14px_rgba(255,212,0,0.75),0_0_26px_rgba(255,212,0,0.3)]" />
        </div>

        {/* CHARCOAL — Slow orbital particle */}
        <div className="absolute z-0 h-3.5 w-3.5 animate-quantum-green">
          <div className="h-full w-full rounded-full bg-brand-charcoal shadow-[0_0_12px_rgba(26,26,26,0.55),0_0_24px_rgba(26,26,26,0.2)]" />
        </div>
      ...
      <style>{`
        /*
         * Quantum Cloud Loader (MySaC brand palette)
         *
         * Design principles:
         * - No gradients
